...
export function createComponentsPanel(app, theme) {
  ...
  ui.showAllBtn.addEventListener("click", () => {
    ...
    // Keep ComponentsPanel "Show all" camera behavior identical to Viewer Tools > Iso.
    // app.showAll restores visibility; app.viewIso applies the same final camera formula.
    try { app.viewIso?.(); } catch (_) {}
