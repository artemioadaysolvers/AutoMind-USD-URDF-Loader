...
// AutoMind URDF+ loader for the modular USD-style viewer shell.
...
async function ensureClassicLoaderScripts() {
  assertThree();
  const scripts = [];
  if (!THREE.ColladaLoader) scripts.push('https://cdn.jsdelivr.net/npm/three@0.132.2/examples/js/loaders/ColladaLoader.js');
  if (!THREE.STLLoader) scripts.push('https://cdn.jsdelivr.net/npm/three@0.132.2/examples/js/loaders/STLLoader.js');
  if (!THREE.OBJLoader) scripts.push('https://cdn.jsdelivr.net/npm/three@0.132.2/examples/js/loaders/OBJLoader.js');
