...
// BUILD211: texture-correct OBJ UVs + synchronized closed-chain viewport + static-grid previews.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD212_CONTEXTUAL_AXIS_VALIDATION',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD212_CONTEXTUAL_AXIS_VALIDATION', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD212_CONTEXTUAL_AXIS_VALIDATION';
