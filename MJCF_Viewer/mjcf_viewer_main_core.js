...
// AutoMind MJCF viewer main entrypoint. Direct modular viewer, direct modular renderer, no legacy DOM adapter.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD181_POST_JOINT_FRAMES',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD181_POST_JOINT_FRAMES', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD181_POST_JOINT_FRAMES';
